                    ...
                    <div class="modal-body">
                      ...
                      <table class="table table-striped">
                        ...
                        <tr class="from-group">
                            ...
                            <td><input id="reason" type="text" class="form-control" name="reason" required  pattern="([A-Za-z0-9\s]){3,}" title="Special characters are not allowed.Minimum 3 letters required."></td>
                        </tr>
                        <tr class="from-group">
