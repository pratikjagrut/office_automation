...
@section('content')
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-4">
				<div class="well">
					<form class="form-inline" action="/listOnGoingJobs" method="get">
							...
							@if (count($jobs) > 0)
								...
								@foreach ($jobs as $job)
									<tr>
										...
										<td>
											<button class="btn btn-success btn-sm" style="color: white;" data-toggle="modal" data-target="#troubleshoot" id="{{$job->ticket}}" onclick="troubleshootJob(this.id)">Troubleshoot</button>
										</td>
										<td>
